...
class WalletsService(
    ...
    fun insertWAL(request: WalletsRequestDTO, userId: Int): Int {
    ...
    fun updateWAL(requestDTO: WalletsRequestDTO, userId: Int): Boolean {
    ...
    fun deleteWAL(walNum: Int, userId: Int): Boolean {
        val now = LocalDateTime.now()
        val currentDate = now.format(DateTimeFormatter.ofPattern("yyyyMMdd"))
        val currentTime = now.format(DateTimeFormatter.ofPattern("HHmmss"))
